...
def main():
    implementation_to_args = {
        ...
        "tensorstore_python": [
            "./src/zarr_benchmarks/tensorstore_python_benchmark_roundtrip.py"
        ],
        "zarr_python": ["./src/zarr_benchmarks/zarr_python_benchmark_roundtrip.py"],
        "zarr_dask_python": [
            "./src/zarr_benchmarks/zarr_dask_python_benchmark_roundtrip.py"
        ],
        "zarrs_python": ["./src/zarr_benchmarks/zarrs_python_benchmark_roundtrip.py"],
        "zarrs_dask_python": [
            "./src/zarr_benchmarks/zarrs_dask_python_benchmark_roundtrip.py"
        ],
    }
    ...
    print(df)
    print()
    df.to_csv("measurements/benchmark_roundtrip.csv")

    # Print and save markdown
    df_markdown = df.copy()
    df_markdown.columns = columns_markdown
    print(df_markdown.to_markdown(floatfmt=".02f"))
    df_markdown.to_markdown("measurements/benchmark_roundtrip.md", floatfmt=".02f")
